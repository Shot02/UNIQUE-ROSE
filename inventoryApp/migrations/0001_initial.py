...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_terms",
                    models.CharField(
                        blank=True, default="Cash on Delivery", max_length=100
                    ),
                ),
                (
                    "lead_time_days",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expiry_date",
                    models.DateField(
                        blank=True, help_text="Product expiry date", null=True
                    ),
                ),
                (
                    "manufacturing_date",
                    models.DateField(
                        blank=True, help_text="Date of manufacture", null=True
                    ),
                ),
                (
                    "batch_number",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Shelf/Storage location",
                        max_length=100,
                        null=True,
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="product",
            index=models.Index(
                fields=["expiry_date"], name="products_expiry__b7e905_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="product",
